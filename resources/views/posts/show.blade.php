        ...
        <article class="max-w-4xl mx-auto mt-20 space-y-6 pt-10">
            <div class="lg:grid lg:grid-cols-12 gap-x-10">
                <div class="col-span-4 text-center">
                    <img src="/images/illustration-1.png" alt="First Illustration" class="rounded-xl">
                ...
                <div class="col-span-8">
                    <div class="flex justify-between mb-6 -mt-10">
                        <a href="/"
                            ...
                            <svg class="mr-2" width="19" height="19" viewBox="0 0 22 22">
                            ...
                            <form method="POST" action="/posts/{{ $post->slug }}/comments">
                                ...
                                <div class="mt-6">
                                    <textarea class="w-full text-sm focus:outline-none focus:ring"
                                        placeholder="Quick, think of something to say!" name="body" rows="5"></textarea>
                                </div>
                                <div class="flex justify-end mt-6 pt-6 border-t border-gray-200">
                                    <button type="submit"
                                        class="bg-blue-500 hover:bg-blue-600 text-white uppercase font-semibold text-xs py-2 px-10 rounded-2xl">
                                        Post
                                    </button>
                                </div>
                            </form>
